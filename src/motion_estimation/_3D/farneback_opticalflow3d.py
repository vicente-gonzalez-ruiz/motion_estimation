...
GAUSS_SIZE = 9      # Side of the Gaussian applicability window used
                    # during the polynomial expansion. Applicability
                    # (that is, the relative importance of the points
                    # in the neighborhood) size should match the scale
                    # of the structures we wnat to estimate
                    # orientation for (page 77). However, small
                    # applicabilities are more sensitive to noise.
